...
func createMethodologySource(t *testing.T) string {
	...
	writeFile(t, filepath.Join(root, "skills", "product-definition", "SKILL.md"), "---\nname: spire-product-definition\ndescription: Use this skill in plan mode to create or update docs/specs/PRODUCT.md.\n---\n\n# Product Definition\n")
	writeFile(t, filepath.Join(root, "skills", "new-feature", "SKILL.md"), "---\nname: spire-new-feature\ndescription: Scaffold a new feature spec and change folder.\n---\n\n# New Feature\n")
	writeFile(t, filepath.Join(root, "skills", "grill-me", "SKILL.md"), "---\nname: spire-grill-me\ndescription: Interview the user relentlessly about a plan or design.\n---\n\n# Grill Me\n")
	writeFile(t, filepath.Join(root, "skills", "architecture-definition", "SKILL.md"), "---\nname: spire-architecture-definition\ndescription: Use this skill in plan mode to create or update docs/architecture/ARCHITECTURE.md.\n---\n\n# Architecture Definition\n")
